// features/map/presentation/bloc/map_bloc.dart
...
class MapBloc extends Bloc<MapEvent, MapState> {
  ...
  MapBloc(this.trafficUseCase, this.locationUseCase) : super(const MapState.initial()) {
      ...
      await event.map(
        started: (_) async {
          ...
          try {
            ...
            emit(MapState.loaded(cameras: cameras, userLat: null, userLng: null));
          } catch (_) {
        ...
        fetchUserLocation: (_) async {
          try {
            ...
            add(MapEvent.locationUpdated(position.latitude, position.longitude));
          } catch (e) {
